...
public class TokenPartitionerTest
{
    ...
    {
        final TokenRangeMapping<RingInstance> tokenRangeMapping = TokenRangeMappingUtils.buildTokenRangeMapping(0, ImmutableMap.of("DC1", 3), 3);
    ...
    {
        final TokenRangeMapping<RingInstance> tokenRangeMapping = TokenRangeMappingUtils.buildTokenRangeMapping(0, ImmutableMap.of("DC1", 3, "DC2", 0), 3);
        partitioner = new TokenPartitioner(tokenRangeMapping, 1, 2, 1, false);
        assertEquals(4, partitioner.numPartitions());
        assertEquals(0, getPartitionForToken(new BigInteger("-9223372036854775807")));
        assertEquals(0, getPartitionForToken(0));
