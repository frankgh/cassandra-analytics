...
//            clearSparkSizeEstimatorMemory();
    ...
    static SparkConf generateSparkConf()
    {
        SparkConf sparkConf = new SparkConf()
                              ...
                              .set("spark.cassandra_analytics.sidecar.request.retries.delay.milliseconds", "200")
                              .set("spark.cassandra_analytics.sidecar.request.retries.max.delay.milliseconds", "200");
