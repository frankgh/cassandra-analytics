...
public class TokenPartitionerTest
{
    ...
    {
        final CassandraRing ring = RingUtils.buildRing(ImmutableMap.of("DC1", 3, "DC2", 0), "test");
    ...
    public void testSplitCalculationsUsingCores()
    {
        ...
        partitioner = new TokenPartitioner(tokenRangeMapping, ring, -1, 50, 100, false);
    ...
    {
        CassandraRing ring = RingUtils.buildRing("DC1", "test");
        TokenRangeMapping<RingInstance> tokenRangeMapping = RingUtils.buildTokenRangeMapping(0, ImmutableMap.of("DC1", 3), 3);
        // When passed "-1" for numberSplits, the token partitioner should calculate it on its own based on the number of cores
        ...
        partitioner = new TokenPartitioner(tokenRangeMapping, ring, -1, 200, 100, false);
    ...
    public void testSplitCalculationWithMultipleDcs()
    {
        ImmutableMap<String, Integer> dcMap = ImmutableMap.<String, Integer>builder()
                                                          ...
                                                          .put("DC4", 3)
                                                          .build();
        CassandraRing ring = RingUtils.buildRing(dcMap, "test");
        TokenRangeMapping<RingInstance> tokenRangeMapping = RingUtils.buildTokenRangeMapping(0, dcMap, 20);
        partitioner = new TokenPartitioner(tokenRangeMapping, ring, -1, 1, 750, false);
