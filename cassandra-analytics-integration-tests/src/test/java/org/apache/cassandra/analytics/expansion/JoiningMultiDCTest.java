...
public class JoiningMultiDCTest extends JoiningTestBase
{
    ...
    {
        static CountDownLatch transitioningStateStart = new CountDownLatch(6);
        static CountDownLatch transitioningStateEnd = new CountDownLatch(6);
        ...
        {
            transitioningStateStart = new CountDownLatch(6);
            transitioningStateEnd = new CountDownLatch(6);
        }
    }
